...
const en = {
  ...
  startTonesHint: "Before a fresh start, plays each voice's first note, top voice first",
...
const de: Record<keyof typeof en, string> = {
  ...
  startTonesHint: 'Spielt vor einem Neustart den ersten Ton jeder Stimme, von oben nach unten',
