...
const en = {
  ...
  startTonesHint: "Before a fresh start, sings each voice's first note, top voice first, then the chord",
...
const de: Record<keyof typeof en, string> = {
  ...
  startTonesHint: 'Singt vor einem Neustart den ersten Ton jeder Stimme von oben nach unten, dann den Akkord',
